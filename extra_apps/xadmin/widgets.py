...
class AdminDateWidget(forms.DateInput):
    ...
    # InitData.getCategories(0)
    # InitData.getGeoLoc(0)
    # InitData.getLanguages(0)
    # InitData.getMinimumPrices(0)
    # InitData.getBrowsers(0)
    # InitData.getMobileCarriers(0)
    # InitData.getOperatingSystem(0)
    # InitData.getDevices(0)
    # InitData.getAdType(0)
    # InitData.getAllCamp(0)


    # 没做更新，不可用
    # InitData.getUserAdFile(0)
